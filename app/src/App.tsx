...
export default function App() {
  ...
  return <main className="app-shell">
    ...
    {screen === 'history' && <History results={results} syncStatus={syncStatus} onBack={() => nav('home')} onSelect={(item) => { setSelected(item); setStyle(item.style); setDistance(item.distanceMeters); nav('detail') }} onNav={nav} />}
